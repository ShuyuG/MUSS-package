...
// Gaussian_path
List Gaussian_path(const Eigen::MatrixXd Z, const Eigen::VectorXd y, const Eigen::VectorXd tauList, const NumericVector spike_params, const float slab_param, const Eigen::VectorXd beta_init, const bool sigma_update, const float sigma_init, const float theta_init, const float a, const float b, const float omega, const float kappa, const float tolerance, const int max_iter, const bool return_g);
RcppExport SEXP _MUSS_Gaussian_path(SEXP ZSEXP, SEXP ySEXP, SEXP tauListSEXP, SEXP spike_paramsSEXP, SEXP slab_paramSEXP, SEXP beta_initSEXP, SEXP sigma_updateSEXP, SEXP sigma_initSEXP, SEXP theta_initSEXP, SEXP aSEXP, SEXP bSEXP, SEXP omegaSEXP, SEXP kappaSEXP, SEXP toleranceSEXP, SEXP max_iterSEXP, SEXP return_gSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Gaussian_path(Z, y, tauList, spike_params, slab_param, beta_init, sigma_update, sigma_init, theta_init, a, b, omega, kappa, tolerance, max_iter, return_g));
...
RcppExport SEXP _MUSS_Laplacian_path(SEXP ZSEXP, SEXP ySEXP, SEXP tauListSEXP, SEXP spike_paramsSEXP, SEXP slab_paramSEXP, SEXP beta_initSEXP, SEXP sigma_updateSEXP, SEXP sigma_initSEXP, SEXP theta_initSEXP, SEXP aSEXP, SEXP bSEXP, SEXP omegaSEXP, SEXP kappaSEXP, SEXP toleranceSEXP, SEXP max_iterSEXP, SEXP return_gSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd >::type Z(ZSEXP);
...
RcppExport SEXP _MUSS_posteriorX(SEXP ZSEXP, SEXP ySEXP, SEXP betaSEXP, SEXP sigmaSEXP, SEXP tauListSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd >::type Z(ZSEXP);
...
RcppExport SEXP _MUSS_comp_g(SEXP LaplacianSEXP, SEXP ySEXP, SEXP ZSEXP, SEXP tauListSEXP, SEXP hatSigmaSEXP, SEXP hatXSEXP, SEXP hatXXSEXP, SEXP p_kSEXP, SEXP spike_paramSEXP, SEXP slab_paramSEXP, SEXP omegaSEXP, SEXP kappaSEXP, SEXP aSEXP, SEXP bSEXP, SEXP sigmaSEXP, SEXP thetaSEXP, SEXP betaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_MUSS_Gaussian_path", (DL_FUNC) &_MUSS_Gaussian_path, 16},
    {"_MUSS_Laplacian_path", (DL_FUNC) &_MUSS_Laplacian_path, 16},
    {"_MUSS_posteriorX", (DL_FUNC) &_MUSS_posteriorX, 5},
    {"_MUSS_comp_g", (DL_FUNC) &_MUSS_comp_g, 17},
    {NULL, NULL, 0}
};

RcppExport void R_init_MUSS(DllInfo *dll) {
